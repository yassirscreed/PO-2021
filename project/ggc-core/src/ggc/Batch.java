...
public class Batch implements Serializable{
    ...
    public Batch(String prodID, String partnerID, int quatity, double price){
        _prodID = prodID;
        ...
        if (_product == null)
            throw UnknownPartnerKeyException();
    }
    ...
    public String toString(){
        return _product.getId() + "|" + getPartnerID() + "|" + getPrice() + "|" + getQuantity() + "\n"; 
    }
}
